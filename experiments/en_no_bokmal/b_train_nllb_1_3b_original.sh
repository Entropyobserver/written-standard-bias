...
#SBATCH -t 30:00:00
#SBATCH -J p2_13b_orig
#SBATCH -o logs/p2_13b_orig_%j.out
#SBATCH -e logs/p2_13b_orig_%j.err
...
cd "$PROJECT_DIR"
python experiments/en_no_bokmal/b_train.py --data original --model-id nllb_1_3b
