...
#SBATCH -t 24:00:00
#SBATCH -J p2_13b_origsub
#SBATCH -o logs/p2_13b_origsub_%j.out
#SBATCH -e logs/p2_13b_origsub_%j.err
...
cd "$PROJECT_DIR"
python experiments/en_no_bokmal/b_train.py --data original_subsampled --model-id nllb_1_3b
