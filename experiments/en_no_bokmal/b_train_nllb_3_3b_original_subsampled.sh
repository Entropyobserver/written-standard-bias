...
#SBATCH -t 48:00:00
#SBATCH -J p2_33b_origsub
#SBATCH -o logs/p2_33b_origsub_%j.out
#SBATCH -e logs/p2_33b_origsub_%j.err
...
cd "$PROJECT_DIR"
python experiments/en_no_bokmal/b_train.py --data original_subsampled --model-id nllb_3_3b
