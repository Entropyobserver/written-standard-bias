...
#SBATCH -t 8:00:00
#SBATCH -J p2_eval_13b_bok
#SBATCH -o logs/p2_eval_13b_bok_%j.out
#SBATCH -e logs/p2_eval_13b_bok_%j.err
...
cd "$PROJECT_DIR"
python experiments/en_no_bokmal/c_evaluate.py --model bokmal --test bokmal --model-id nllb_1_3b
python experiments/en_no_bokmal/c_evaluate.py --model bokmal --test original --model-id nllb_1_3b
