...
#SBATCH -t 8:00:00
#SBATCH -J p2_eval_13b_sub
#SBATCH -o logs/p2_eval_13b_sub_%j.out
#SBATCH -e logs/p2_eval_13b_sub_%j.err
...
cd "$PROJECT_DIR"
python experiments/en_no_bokmal/c_evaluate.py --model original_subsampled --test bokmal --model-id nllb_1_3b
python experiments/en_no_bokmal/c_evaluate.py --model original_subsampled --test original --model-id nllb_1_3b
