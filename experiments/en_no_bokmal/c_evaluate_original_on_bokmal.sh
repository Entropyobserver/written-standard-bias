...
#SBATCH -t 4:00:00
#SBATCH -J p2_eval_orig_bokmal
#SBATCH -o logs/p2_eval_orig_bokmal_%j.out
#SBATCH -e logs/p2_eval_orig_bokmal_%j.err
...
cd "$PROJECT_DIR"
python experiments/en_no_bokmal/c_evaluate.py --model original --test bokmal
