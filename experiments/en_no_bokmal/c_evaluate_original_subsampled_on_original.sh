...
#SBATCH -t 4:00:00
#SBATCH -J p2_eval_sub_orig
#SBATCH -o logs/p2_eval_sub_orig_%j.out
#SBATCH -e logs/p2_eval_sub_orig_%j.err
...
cd "$PROJECT_DIR"
python experiments/en_no_bokmal/c_evaluate.py --model original_subsampled --test original
